...
Item {
    ...
    // khal query
    readonly property string khalDateRange: "today 2d"
    ...
    Process {
        id: khalProc
        command: ["sh", "-c",
            "khal list --json title --json start --json end " +
            "--json calendar --json description --json all-day --json uid " +
            root.khalDateRange + " | jq -s 'add // []'"]
        running: true
    ...
    MouseArea {
        ...
        onClicked: function(mouse) {
            ...
            AppState.ShellState.khalPopupOpen = !AppState.ShellState.khalPopupOpen;
        }
    }
